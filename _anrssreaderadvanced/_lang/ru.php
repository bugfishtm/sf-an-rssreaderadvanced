...
store_version_name=RSS Reader Advanced
store_version_description=Аккуратная и современная программа для чтения RSS/Atom-лент на Android, созданная как готовый к использованию проект Android Studio и APK-бандл.
